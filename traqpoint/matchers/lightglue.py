# Modified from LightGlue (https://github.com/cvg/LightGlue)
# Copyright (c) 2023, ETH Zurich and Microsoft. Licensed under Apache-2.0.
...
class LightGlue(nn.Module):
    ...
    features = {
        ...
        "traqpoint": {
            "weights": './weights/traqpoint_lg-v2.pth',
            "input_dim": 256,
        },
    }

    def __init__(self, features="traqpoint", **conf) -> None:
        super().__init__()
        ...
        state_dict = None
        if features is not None and features != 'traqpoint':
