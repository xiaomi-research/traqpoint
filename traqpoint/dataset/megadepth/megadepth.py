...
class MegaDepthDataset(Dataset):
    def __init__(
        ...
        self.gray = gray # false
        self.crop_or_scale = crop_or_scale # scale
        self.seed = seed  # save seed

        
        self.scene_info = dict(np.load(npz_path, allow_pickle=True)) # ['image_path','depth_map',intrinsics','pose']
