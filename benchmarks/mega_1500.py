...
def parse_arguments():
    ...
    parser.add_argument("--data_root", type=str, default="/high_perf_store3/evad-autolabeling/lihao_data/lyp-data/megadepth_test_1500", help="Path to the MegaDepth dataset.")
    ...
    parser.add_argument("--detection_threshold", type=float, default=0.2, help="Detection threshold for keypoints.")
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        with open(f'outputs/mega_1500/traqpoint_{method}.txt', 'w') as f:
            f.write(str(out))